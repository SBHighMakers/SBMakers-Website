...
validUsers=['jocelyngallardo', 'LucaCC', 'kedehlsen', 'sky-adams', 'JoyP321', 'SBHighMakers']
...
def article_added():
	...
	flash('You successfully posted the news article: ' + request.form['articleTitle'] , 'success')
